...
set Banghak1_risk     (count people with [color = red and districtName = "Banghak1" and destinationName != "others"])   / (count people with [districtName = "Banghak1" and destinationName != "others"])    * 100
set Banghak2_risk  (count people with [color = red and districtName = "Banghak2" and destinationName != "others"])/ (count people with [districtName = "Banghak2" and destinationName != "others"]) * 100
set Banghak3_risk  (count people with [color = red and districtName = "Banghak3" and destinationName != "others"])/ (count people with [districtName = "Banghak3" and destinationName != "others"]) * 100
set Chang1_risk  (count people with [color = red and districtName = "Chang1" and destinationName != "others"])/ (count people with [districtName = "Chang1" and destinationName != "others"]) * 100
set Chang2_risk  (count people with [color = red and districtName = "Chang2" and destinationName != "others"])/ (count people with [districtName = "Chang2" and destinationName != "others"]) * 100
set Chang3_risk   (count people with [color = red and districtName = "Chang3" and destinationName != "others"]) / (count people with [districtName = "Chang3" and destinationName != "others"])  * 100
set Chang4_risk   (count people with [color = red and districtName = "Chang4" and destinationName != "others"]) / (count people with [districtName = "Chang4" and destinationName != "others"])  * 100
set Chang5_risk  (count people with [color = red and districtName = "Chang5" and destinationName != "others"])/ (count people with [districtName = "Chang5" and destinationName != "others"]) * 100
set Dobong1_risk  (count people with [color = red and districtName = "Dobong1" and destinationName != "others"])/ (count people with [districtName = "Dobong1" and destinationName != "others"]) * 100
set Dobong2_risk    (count people with [color = red and districtName = "Dobong2" and destinationName != "others"])  / (count people with [districtName = "Dobong2" and destinationName != "others"])   * 100
set Ssangmun1_risk    (count people with [color = red and districtName = "Ssangmun1" and destinationName != "others"])  / (count people with [districtName = "Ssangmun1" and destinationName != "others"])   * 100
set Ssangmun2_risk    (count people with [color = red and districtName = "Ssangmun2" and destinationName != "others"])  / (count people with [districtName = "Ssangmun2" and destinationName != "others"])   * 100
set Ssangmun3_risk    (count people with [color = red and districtName = "Ssangmun3" and destinationName != "others"])  / (count people with [districtName = "Ssangmun3" and destinationName != "others"])   * 100
set Ssangmun4_risk     (count people with [color = red and districtName = "Ssangmun4" and destinationName != "others"])   / (count people with [districtName = "Ssangmun4" and destinationName != "others"])    * 100
...
to set-gis-data
  ...
  gis:load-coordinate-system (word "boundary/boundary_shape/Dobong.prj")
  set gu   gis:load-dataset "boundary/boundary_shape/Dobong.shp"
  set lc   gis:load-dataset "landcover/Dobong.shp"
  set road gis:load-dataset "roads/roads_shape/dobong.shp"
  set land gis:load-dataset "LandPrice/LandPrice_Gu_Shape/Landprice_Dobong.shp"
...
foreach gis:feature-list-of gu [ gu-feature ->
    gis:set-drawing-color scale-color green (gis:property-value gu-feature "ADM_CD") 1110051 1110065
...
; Import daily pollution
  let p0 csv:from-file "Pollution/St111171_Dobong.csv"
...
if ID = 10 [set size 1 set age 55 + random 5 set color brown
            ...
            if (0.02 < r and r <= 0.15)[set edu 1]
            if (0.15 < r and r <= 0.35)[set edu 2]
            if (0.35 < r and r <= 0.79)[set edu 3]
...
if ID = 11 [set size 1 set age 60 + random 5 set color violet
            ...
            if (0.03 < r and r <= 0.24)[set edu 1]
...
if ID = 12 [set size 1 set age 65 + random 5 set color violet
            ...
            if (0.05 < r and r <= 0.33)[set edu 1]
            if (0.33 < r and r <= 0.55)[set edu 2]
            if (0.55 < r and r <= 0.85)[set edu 3]
...
if ID = 13 [set size 1 set age 70 + random 5 set color violet
            ...
            if (0.10 < r and r <= 0.43)[set edu 1]
            if (0.43 < r and r <= 0.52)[set edu 2]
            if (0.52 < r and r <= 0.76)[set edu 3]
            if (0.76 < r and r <= 0.79)[set edu 4]
            if (0.79 < r and r <= 0.89)[set edu 5]
...
if ID = 14 [set size 1 set age 75 + random 5 set color violet
            ...
            if (0.51 < r and r <= 0.67)[set edu 2]
...
if ID = 15 [set size 1 set age 80 + random 5 set color pink
            ...
            if (0.24 < r and r <= 0.61)[set edu 1]
            if (0.61 < r and r <= 0.74)[set edu 2]
            if (0.74 < r and r <= 0.89)[set edu 3]
