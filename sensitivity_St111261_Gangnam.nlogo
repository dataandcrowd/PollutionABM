...
set Nonhyeon1_risk (count people with [color = red and districtName = "Nonhyeon1" and destinationName != "others"]) / (count people with [districtName = "Nonhyeon1" and destinationName != "others"]) * 100
set Nonhyeon2_risk  (count people with [color = red and districtName = "Nonhyeon2" and destinationName != "others"])/ (count people with [districtName = "Nonhyeon2" and destinationName != "others"]) * 100
set Samseong1_risk  (count people with [color = red and districtName = "Samseong1" and destinationName != "others"])/ (count people with [districtName = "Samseong1" and destinationName != "others"]) * 100
set Samseong2_risk  (count people with [color = red and districtName = "Samseong2" and destinationName != "others"])/ (count people with [districtName = "Samseong2" and destinationName != "others"]) * 100
set Daechi1_risk  (count people with [color = red and districtName = "Daechi1" and destinationName != "others"]) / (count people with [districtName = "Daechi1" and destinationName != "others"])  * 100
set Daechi4_risk  (count people with [color = red and districtName = "Daechi4" and destinationName != "others"]) / (count people with [districtName = "Daechi4" and destinationName != "others"])  * 100
set Yeoksam1_risk  (count people with [color = red and districtName = "Yeoksam1" and destinationName != "others"])/ (count people with [districtName = "Yeoksam1" and destinationName != "others"]) * 100
set Yeoksam2_risk  (count people with [color = red and districtName = "Yeoksam2" and destinationName != "others"])/ (count people with [districtName = "Yeoksam2" and destinationName != "others"]) * 100
set Dogok1_risk  (count people with [color = red and districtName = "Dogok1" and destinationName != "others"])  / (count people with [districtName = "Dogok1" and destinationName != "others"])   * 100
set Dogok2_risk  (count people with [color = red and districtName = "Dogok2" and destinationName != "others"])  / (count people with [districtName = "Dogok2" and destinationName != "others"])   * 100
set Gaepo1_risk  (count people with [color = red and districtName = "Gaepo1" and destinationName != "others"])  / (count people with [districtName = "Gaepo1" and destinationName != "others"])   * 100
set Gaepo2_risk  (count people with [color = red and districtName = "Gaepo2" and destinationName != "others"])  / (count people with [districtName = "Gaepo2" and destinationName != "others"])   * 100
set Gaepo4_risk  (count people with [color = red and districtName = "Gaepo4" and destinationName != "others"])  / (count people with [districtName = "Gaepo4" and destinationName != "others"])   * 100
set Ilwonbon_risk (count people with [color = red and districtName = "Ilwonbon" and destinationName != "others"])  / (count people with [districtName = "Ilwonbon" and destinationName != "others"])   * 100

set Ilwon1_risk  (count people with [color = red and districtName = "Ilwon1" and destinationName != "others"])   / (count people with [districtName = "Ilwon1" and destinationName != "others"])    * 100
set Ilwon2_risk  (count people with [color = red and districtName = "Ilwon2" and destinationName != "others"])  / (count people with [districtName = "Ilwon2" and destinationName != "others"])   * 100
set Suseo_risk  (count people with [color = red and districtName = "Suseo" and destinationName != "others"])   / (count people with [districtName = "Suseo" and destinationName != "others"])    * 100
set Apgujeong1_risk  (count people with [color = red and districtName = "Apgujeong1" and destinationName != "others"])  / (count people with [districtName = "Apgujeong1" and destinationName != "others"])   * 100
set Cheongdam_risk  (count people with [color = red and districtName = "Cheongdam" and destinationName != "others"])   / (count people with [districtName = "Cheongdam" and destinationName != "others"])    * 100
set Daechi2_risk  (count people with [color = red and districtName = "Daechi2" and destinationName != "others"])  / (count people with [districtName = "Daechi2" and destinationName != "others"])   * 100
set Segok_risk  (count people with [color = red and districtName = "Segok" and destinationName != "others"])  / (count people with [districtName = "Segok" and destinationName != "others"])   * 100
...
to set-gis-data
  ...
  gis:load-coordinate-system (word "boundary/boundary_shape/Gangnam.prj")
  set gu   gis:load-dataset "boundary/boundary_shape/Gangnam.shp"
  set lc   gis:load-dataset "landcover/Gangnam.shp"
  set road gis:load-dataset "roads/roads_shape/gangnam.shp"
  set land gis:load-dataset "LandPrice/LandPrice_Gu_Shape/Landprice_Gangnam.shp"
...
foreach gis:feature-list-of gu [ gu-feature ->
    gis:set-drawing-color scale-color green (gis:property-value gu-feature "ADM_CD") 1123051 1123080
...
; Import daily pollution
  let p0 csv:from-file "Pollution/St111261_Gangnam.csv"
...
;;Scenarios
  let quarter csv:from-file "Scenarios/St111261_Gangnam.csv"
...
if ID = 8  [set size 1 set age 45 + random 5 set color brown
            ...
            if (0.22 < r and r <= 0.31)[set edu 4]
            if (0.31 < r and r <= 0.79)[set edu 5]
            if (0.79 < r and r <= 0.93)[set edu 6]
            if (0.93 < r )[set edu 7]]
if ID = 9  [set size 1 set age 50 + random 5 set color brown
            let r random-float 1
            if (0    < r and r <= 0.02)[set edu 1]
            if (0.02 < r and r <= 0.06)[set edu 2]
            if (0.06 < r and r <= 0.32)[set edu 3]
            if (0.32 < r and r <= 0.40)[set edu 4]
            if (0.40 < r and r <= 0.81)[set edu 5]
            if (0.81 < r and r <= 0.92)[set edu 6]
            if (0.92 < r )[set edu 7]]
if ID = 10 [set size 1 set age 55 + random 5 set color brown
            let r random-float 1
            if (0    < r and r <= 0.04)[set edu 1]
            if (0.04 < r and r <= 0.11)[set edu 2]
            if (0.11 < r and r <= 0.39)[set edu 3]
            if (0.39 < r and r <= 0.46)[set edu 4]
            if (0.46 < r and r <= 0.85)[set edu 5]
            if (0.85 < r and r <= 0.92)[set edu 6]
            if (0.92 < r )[set edu 7]]
if ID = 11 [set size 1 set age 60 + random 5 set color violet
            let r random-float 1
            if (0    < r and r <= 0.01)[set edu 0]
            if (0.01 < r and r <= 0.08)[set edu 1]
            if (0.08 < r and r <= 0.16)[set edu 2]
            if (0.16 < r and r <= 0.43)[set edu 3]
            if (0.43 < r and r <= 0.49)[set edu 4]
            if (0.49 < r and r <= 0.89)[set edu 5]
            if (0.89 < r and r <= 0.97)[set edu 6]
            if (0.97 < r )[set edu 7]]
if ID = 12 [set size 1 set age 65 + random 5 set color violet
            let r random-float 1
            if (0    < r and r <= 0.02)[set edu 0]
            if (0.02 < r and r <= 0.12)[set edu 1]
            if (0.12 < r and r <= 0.21)[set edu 2]
            if (0.21 < r and r <= 0.46)[set edu 3]
            if (0.46 < r and r <= 0.52)[set edu 4]
...
if ID = 13 [set size 1 set age 70 + random 5 set color violet
            ...
            if (0.05 < r and r <= 0.21)[set edu 1]
            if (0.21 < r and r <= 0.31)[set edu 2]
            if (0.31 < r and r <= 0.54)[set edu 3]
            if (0.54 < r and r <= 0.59)[set edu 4]
            if (0.59 < r and r <= 0.90)[set edu 5]
            if (0.90 < r and r <= 0.96)[set edu 6]
            if (0.96 < r )[set edu 7]]
if ID = 14 [set size 1 set age 75 + random 5 set color violet
            let r random-float 1
            if (0    < r and r <= 0.10)[set edu 0]
            if (0.10 < r and r <= 0.34)[set edu 1]
            if (0.34 < r and r <= 0.45)[set edu 2]
            if (0.45 < r and r <= 0.68)[set edu 3]
            if (0.68 < r and r <= 0.72)[set edu 4]
            if (0.72 < r and r <= 0.94)[set edu 5]
            if (0.94 < r and r <= 0.98)[set edu 6]
            if (0.98 < r )[set edu 7]]
if ID = 15 [set size 1 set age 80 + random 5 set color pink
            let r random-float 1
            if (0    < r and r <= 0.17)[set edu 0]
            if (0.17 < r and r <= 0.48)[set edu 1]
            if (0.48 < r and r <= 0.60)[set edu 2]
            if (0.60 < r and r <= 0.79)[set edu 3]
            if (0.79 < r and r <= 0.84)[set edu 4]
...
if ID = 16 [set size 1 set age 85 + random 15 set color pink
            ...
            if (0.29 < r and r <= 0.62)[set edu 1]
            if (0.62 < r and r <= 0.71)[set edu 2]
            if (0.71 < r and r <= 0.86)[set edu 3]
...
to set-destination   ;; Decomposing matrix
  let gncsv csv:from-file "ODmatrix/St111261_Gangnam.csv"
...
to pm10-plot
  ...
  set-current-plot-pen "pm10-shinsa-road"  plot [ts__kal] of patch 24 253
end
@#$#@#$#@
GRAPHICS-WINDOW
527
...
"" ""
PENS
"shinsa_risk" 1.0 0 -7500403 true "" ""
