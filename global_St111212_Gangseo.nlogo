...
set Balsan1_risk     (count people with [color = red and districtName = "Balsan1" and destinationName != "others"])   / (count people with [districtName = "Balsan1" and destinationName != "others"])    * 100
set Banghwa1_risk  (count people with [color = red and districtName = "Banghwa1" and destinationName != "others"])/ (count people with [districtName = "Banghwa1" and destinationName != "others"]) * 100
set Banghwa2_risk  (count people with [color = red and districtName = "Banghwa2" and destinationName != "others"])/ (count people with [districtName = "Banghwa2" and destinationName != "others"]) * 100
set Banghwa3_risk  (count people with [color = red and districtName = "Banghwa3" and destinationName != "others"])/ (count people with [districtName = "Banghwa3" and destinationName != "others"]) * 100
set Deungchon1_risk  (count people with [color = red and districtName = "Deungchon1" and destinationName != "others"])/ (count people with [districtName = "Deungchon1" and destinationName != "others"]) * 100
set Deungchon2_risk   (count people with [color = red and districtName = "Deungchon2" and destinationName != "others"]) / (count people with [districtName = "Deungchon2" and destinationName != "others"])  * 100
set Deungchon3_risk   (count people with [color = red and districtName = "Deungchon3" and destinationName != "others"]) / (count people with [districtName = "Deungchon3" and destinationName != "others"])  * 100
set Gayang1_risk  (count people with [color = red and districtName = "Gayang1" and destinationName != "others"])/ (count people with [districtName = "Gayang1" and destinationName != "others"]) * 100
set Gayang2_risk  (count people with [color = red and districtName = "Gayang2" and destinationName != "others"])/ (count people with [districtName = "Gayang2" and destinationName != "others"]) * 100
set Gayang3_risk    (count people with [color = red and districtName = "Gayang3" and destinationName != "others"])  / (count people with [districtName = "Gayang3" and destinationName != "others"])   * 100
set Gonghang_risk    (count people with [color = red and districtName = "Gonghang" and destinationName != "others"])  / (count people with [districtName = "Gonghang" and destinationName != "others"])   * 100
set Hwagok1_risk    (count people with [color = red and districtName = "Hwagok1" and destinationName != "others"])  / (count people with [districtName = "Hwagok1" and destinationName != "others"])   * 100
set Hwagok2_risk    (count people with [color = red and districtName = "Hwagok2" and destinationName != "others"])  / (count people with [districtName = "Hwagok2" and destinationName != "others"])   * 100
set Hwagok3_risk     (count people with [color = red and districtName = "Hwagok3" and destinationName != "others"])   / (count people with [districtName = "Hwagok3" and destinationName != "others"])    * 100
set Hwagok4_risk     (count people with [color = red and districtName = "Hwagok4" and destinationName != "others"])   / (count people with [districtName = "Hwagok4" and destinationName != "others"])    * 100
set Hwagok6_risk     (count people with [color = red and districtName = "Hwagok6" and destinationName != "others"])   / (count people with [districtName = "Hwagok6" and destinationName != "others"])    * 100
set Hwagok8_risk     (count people with [color = red and districtName = "Hwagok8" and destinationName != "others"])   / (count people with [districtName = "Hwagok8" and destinationName != "others"])    * 100
set Hwagokbon_risk  (count people with [color = red and districtName = "Hwagokbon" and destinationName != "others"])/ (count people with [districtName = "Hwagokbon" and destinationName != "others"]) * 100
set Woojangsan_risk   (count people with [color = red and districtName = "Woojangsan" and destinationName != "others"]) / (count people with [districtName = "Woojangsan" and destinationName != "others"])  * 100
set Yeomchang_risk    (count people with [color = red and districtName = "Yeomchang" and destinationName != "others"])  / (count people with [districtName = "Yeomchang" and destinationName != "others"])   * 100
...
to set-gis-data
  ...
  set lc   gis:load-dataset "landcover/Gangseo.shp"
