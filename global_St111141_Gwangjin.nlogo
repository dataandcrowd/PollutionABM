...
set Gunja_risk     (count people with [color = red and districtName = "Gunja" and destinationName != "others"])   / (count people with [districtName = "Gunja" and destinationName != "others"])    * 100
set Gui1_risk  	(count people with [color = red and districtName = "Gui1" and destinationName != "others"])/ (count people with [districtName = "Gui1" and destinationName != "others"]) * 100
set Gui2_risk  (count people with [color = red and districtName = "Gui2" and destinationName != "others"])/ (count people with [districtName = "Gui2" and destinationName != "others"]) * 100
set Gui3_risk  (count people with [color = red and districtName = "Gui3" and destinationName != "others"])/ (count people with [districtName = "Gui3" and destinationName != "others"]) * 100
set Gwangjang_risk  (count people with [color = red and districtName = "Gwangjang" and destinationName != "others"])/ (count people with [districtName = "Gwangjang" and destinationName != "others"]) * 100
set Hwayang_risk   (count people with [color = red and districtName = "Hwayang" and destinationName != "others"]) / (count people with [districtName = "Hwayang" and destinationName != "others"])  * 100
set Jayang1_risk   (count people with [color = red and districtName = "Jayang1" and destinationName != "others"]) / (count people with [districtName = "Jayang1" and destinationName != "others"])  * 100
set Jayang2_risk  (count people with [color = red and districtName = "Jayang2" and destinationName != "others"])/ (count people with [districtName = "Jayang2" and destinationName != "others"]) * 100
set Jayang3_risk  (count people with [color = red and districtName = "Jayang3" and destinationName != "others"])/ (count people with [districtName = "Jayang3" and destinationName != "others"]) * 100
set Jayang4_risk    (count people with [color = red and districtName = "Jayang4" and destinationName != "others"])  / (count people with [districtName = "Jayang4" and destinationName != "others"])   * 100
set Junggok1_risk    (count people with [color = red and districtName = "Junggok1" and destinationName != "others"])  / (count people with [districtName = "Junggok1" and destinationName != "others"])   * 100
set Junggok2_risk    (count people with [color = red and districtName = "Junggok2" and destinationName != "others"])  / (count people with [districtName = "Junggok2" and destinationName != "others"])   * 100
set Junggok3_risk    (count people with [color = red and districtName = "Junggok3" and destinationName != "others"])  / (count people with [districtName = "Junggok3" and destinationName != "others"])   * 100
set Junggok4_risk     (count people with [color = red and districtName = "Junggok4" and destinationName != "others"])   / (count people with [districtName = "Junggok4" and destinationName != "others"])    * 100
set Neungdong_risk    (count people with [color = red and districtName = "Neungdong" and destinationName != "others"])  / (count people with [districtName = "Neungdong" and destinationName != "others"])   * 100
...
to set-gis-data
  ...
  set lc   gis:load-dataset "landcover/Gwangjin.shp"
