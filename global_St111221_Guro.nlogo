...
set Gaebong1_risk     (count people with [color = red and districtName = "Gaebong1" and destinationName != "others"])   / (count people with [districtName = "Gaebong1" and destinationName != "others"])    * 100
set Gaebong2_risk  (count people with [color = red and districtName = "Gaebong2" and destinationName != "others"])/ (count people with [districtName = "Gaebong2" and destinationName != "others"]) * 100
set Gaebong3_risk  (count people with [color = red and districtName = "Gaebong3" and destinationName != "others"])/ (count people with [districtName = "Gaebong3" and destinationName != "others"]) * 100
set Garibong_risk  (count people with [color = red and districtName = "Garibong" and destinationName != "others"])/ (count people with [districtName = "Garibong" and destinationName != "others"]) * 100
set Gocheok1_risk  (count people with [color = red and districtName = "Gocheok1" and destinationName != "others"])/ (count people with [districtName = "Gocheok1" and destinationName != "others"]) * 100
set Gocheok2_risk   (count people with [color = red and districtName = "Gocheok2" and destinationName != "others"]) / (count people with [districtName = "Gocheok2" and destinationName != "others"])  * 100
set Guro1_risk   (count people with [color = red and districtName = "Guro1" and destinationName != "others"]) / (count people with [districtName = "Guro1" and destinationName != "others"])  * 100
set Guro2_risk  (count people with [color = red and districtName = "Guro2" and destinationName != "others"])/ (count people with [districtName = "Guro2" and destinationName != "others"]) * 100
set Guro3_risk  (count people with [color = red and districtName = "Guro3" and destinationName != "others"])/ (count people with [districtName = "Guro3" and destinationName != "others"]) * 100
set Guro4_risk  (count people with [color = red and districtName = "Guro4" and destinationName != "others"])/ (count people with [districtName = "Guro4" and destinationName != "others"]) * 100
set Oryu1_risk    (count people with [color = red and districtName = "Oryu1" and destinationName != "others"])  / (count people with [districtName = "Oryu1" and destinationName != "others"])   * 100
set Oryu2_risk    (count people with [color = red and districtName = "Oryu2" and destinationName != "others"])  / (count people with [districtName = "Oryu2" and destinationName != "others"])   * 100
set Shindorim_risk    (count people with [color = red and districtName = "Shindorim" and destinationName != "others"])  / (count people with [districtName = "Shindorim" and destinationName != "others"])   * 100
set Sugung_risk    (count people with [color = red and districtName = "Sugung" and destinationName != "others"])  / (count people with [districtName = "Sugung" and destinationName != "others"])   * 100
...
to set-gis-data
  ...
  set lc   gis:load-dataset "landcover/Guro.shp"
...
to dong-plot
  ...
  set-current-plot-pen "Gaebong1_risk"     plot((count people with [color = red and districtName = "Gaebong1" and destinationName != "others"])   / (count people with [districtName = "Gaebong1" and destinationName != "others"])    * 100)
	set-current-plot-pen "Gaebong2_risk"  plot((count people with [color = red and districtName = "Gaebong2" and destinationName != "others"])/ (count people with [districtName = "Gaebong2" and destinationName != "others"]) * 100)
	set-current-plot-pen "Gaebong3_risk"  plot((count people with [color = red and districtName = "Gaebong3" and destinationName != "others"])/ (count people with [districtName = "Gaebong3" and destinationName != "others"]) * 100)
	set-current-plot-pen "Garibong_risk"  plot((count people with [color = red and districtName = "Garibong" and destinationName != "others"])/ (count people with [districtName = "Garibong" and destinationName != "others"]) * 100)
	set-current-plot-pen "Gocheok1_risk"  plot((count people with [color = red and districtName = "Gocheok1" and destinationName != "others"])/ (count people with [districtName = "Gocheok1" and destinationName != "others"]) * 100)
	set-current-plot-pen "Gocheok2_risk"   plot((count people with [color = red and districtName = "Gocheok2" and destinationName != "others"]) / (count people with [districtName = "Gocheok2" and destinationName != "others"])  * 100)
	set-current-plot-pen "Guro1_risk"   plot((count people with [color = red and districtName = "Guro1" and destinationName != "others"]) / (count people with [districtName = "Guro1" and destinationName != "others"])  * 100)
	set-current-plot-pen "Guro2_risk"  plot((count people with [color = red and districtName = "Guro2" and destinationName != "others"])/ (count people with [districtName = "Guro2" and destinationName != "others"]) * 100)
	set-current-plot-pen "Guro3_risk"  plot((count people with [color = red and districtName = "Guro3" and destinationName != "others"])/ (count people with [districtName = "Guro3" and destinationName != "others"]) * 100)
	set-current-plot-pen "Guro4_risk"  plot((count people with [color = red and districtName = "Guro4" and destinationName != "others"])/ (count people with [districtName = "Guro4" and destinationName != "others"]) * 100)
	set-current-plot-pen "Oryu1_risk"    plot((count people with [color = red and districtName = "Oryu1" and destinationName != "others"])  / (count people with [districtName = "Oryu1" and destinationName != "others"])   * 100)
	set-current-plot-pen "Oryu2_risk"    plot((count people with [color = red and districtName = "Oryu2" and destinationName != "others"])  / (count people with [districtName = "Oryu2" and destinationName != "others"])   * 100)
	set-current-plot-pen "Shindorim_risk"    plot((count people with [color = red and districtName = "Shindorim" and destinationName != "others"])  / (count people with [districtName = "Shindorim" and destinationName != "others"])   * 100)
	set-current-plot-pen "Sugung_risk"    plot((count people with [color = red and districtName = "Sugung" and destinationName != "others"])  / (count people with [districtName = "Sugung" and destinationName != "others"])   * 100)
end
...
to pm10-plot
  ...
  set-current-plot-pen "pm10-Gocheok2"  plot [ts__kal] of patch 138 119
end
@#$#@#$#@
GRAPHICS-WINDOW
527
...
"" ""
PENS
"Gaebong1_risk" 1.0 0 -7500403 true "" ""
"Gaebong2_risk" 1.0 0 -2674135 true "" ""
"Gaebong3_risk" 1.0 0 -955883 true "" ""
"Garibong_risk" 1.0 0 -6459832 true "" ""
"Gocheok1_risk" 1.0 0 -1184463 true "" ""
"Gocheok2_risk" 1.0 0 -10899396 true "" ""
"Guro1_risk" 1.0 0 -13840069 true "" ""
"Guro2_risk" 1.0 0 -14835848 true "" ""
"Guro3_risk" 1.0 0 -11221820 true "" ""
"Guro4_risk" 1.0 0 -13791810 true "" ""
"Oryu1_risk" 1.0 0 -13345367 true "" ""
"Oryu2_risk" 1.0 0 -8630108 true "" ""
"Shindorim_risk" 1.0 0 -5825686 true "" ""
"Sugung_risk" 1.0 0 -2064490 true "" ""
...
"" ""
PENS
"pm10-Gocheok2" 1.0 0 -7500403 true "" ""
